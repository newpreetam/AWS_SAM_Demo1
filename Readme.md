...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AWS_SAM_Demo1*):
...
Execute unit tests
```
    cd "AWS_SAM_Demo1/test/AWS_SAM_Demo1.Tests"
    dotnet test
```

Deploy application
```
    cd "AWS_SAM_Demo1/src/AWS_SAM_Demo1"
